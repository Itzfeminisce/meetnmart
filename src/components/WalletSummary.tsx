...
import { TrendingUp, Lock, Calendar, History } from 'lucide-react';
import { UserRole, type WalletSummary } from '@/contexts/AuthContext';
...
const WalletSummary: React.FC<WalletSummaryProps> = ({ walletSummary, userRole = "seller" }) => {
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 md:flex md:space-x-4">
                <div className="rounded-xl border bg-card p-4 shadow-sm flex-1">
                    ...
                    <p className="mt-2 text-2xl font-bold text-emerald-600">{formatCurrency(walletSummary.balance)}</p>
                </div>
                <div className="rounded-xl border bg-card p-4 shadow-sm flex-1">
                    <div className="flex items-center justify-between">
                    ...
                    <p className="mt-2 text-2xl font-bold text-blue-600">{formatCurrency(walletSummary.escrowed_balance)}</p>
                </div>
            </div>
