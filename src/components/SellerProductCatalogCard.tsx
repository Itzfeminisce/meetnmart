...
import { Edit, Heart, PenLine } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <CardContent className="p-4 space-y-2">
                ...
                <p className={cn("text-base md:text-lg text-muted-foreground", maxHeight ? "truncate" : "h-auto")} onClick={handleToggleShowDescription}>
                    {product.description}
                </p>
