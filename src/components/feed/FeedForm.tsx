...
import { locations, placeholderExamples, urgencyLevels } from '@/data/pulse-mocks';
...
const getPlaceholder = () => {
  return placeholderExamples[Math.floor(Math.random() * placeholderExamples.length)];
};
        ...
        {showPreview ? (
          ...
          <>
            ...
            <div className="space-y-1">
              <h3 className="text-base md:text-lg font-semibold"> Quick Post</h3>
              <p className="text-xs md:text-sm text-muted-foreground  flex items-center">
                <Info className="w-4 h-4 mr-1" />
                Quickly post what you’re offering or searching for.
              </p>
            </div>
            {/* Main Content Input */}
